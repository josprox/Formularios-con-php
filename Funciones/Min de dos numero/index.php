...
<div class="content3">
  ...
  <h2>Minimo de dos numeros</h2>
  <p>Hola mucho gusto, yo te ayudaré a saber el minimo de dos numeros, por favor dime tus números</p>
</div>
</center>
<form action="respuesta.php" method="post">
    ...
    <div class="form-text text-azul">Cual es tu primera cantidad a comprobar. Ejemplo: 12 es menor que...</div>
  </div>
  <div class="mb-3">
